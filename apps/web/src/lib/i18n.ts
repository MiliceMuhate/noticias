...
const pt = {
  ...
  translatedFrom: 'Tradução, com assistência de IA, do artigo original em português.',
...
const MESSAGES: Record<Lang, Record<MessageKey, string>> = {
  ...
  en: {
    ...
    translatedFrom: 'AI-assisted translation of the original article in Portuguese.',
  ...
  es: {
    ...
    translatedFrom: 'Traducción asistida por IA del artículo original en portugués.',
  ...
  fr: {
    ...
    translatedFrom: 'Traduction assistée par IA de l’article original en portugais.',
