...
8. FORMATO OBRIGATÓRIO — um verificador automático procura estes cabeçalhos
   markdown pelo texto exato, por isso usa-os literalmente, cada um na sua
   própria linha, nesta ordem:
   - (lead, sem cabeçalho, primeiro)
   - "## O que aconteceu"
   - um cabeçalho à tua escolha para o bloco de variação do plano
   - "## Porque é que isto importa"
   - "## O que vem a seguir"
   Podes acrescentar palavras a seguir a "Porque é que isto importa" ou "O que vem
   a seguir" (ex.: "## O que vem a seguir para o Sporting"), mas a frase exata tem
   de estar lá. NUNCA omitas nenhum destes três cabeçalhos.
9. O corpo tem de ter entre 650 e 900 palavras — um artigo mais curto é conteúdo
   fino e é rejeitado automaticamente antes de chegar a um humano.
